...
public class GridWorldQ extends MDPSolver implements LearningAgent, QProvider {
    ...
    public GridWorldQ(SADomain domain, double gamma, HashableStateFactory hashingFactory,
