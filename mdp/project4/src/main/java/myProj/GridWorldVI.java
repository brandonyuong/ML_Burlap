...
public class GridWorldVI extends MDPSolver implements Planner, QProvider {
    ...
    public GridWorldVI(SADomain domain, double gamma,
    ...
    public static void main(String [] args){
        ...
        GridWorldVI vi = new GridWorldVI(domain, 0.99, new SimpleHashableStateFactory(),
